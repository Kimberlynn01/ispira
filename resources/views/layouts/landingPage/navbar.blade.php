...
<nav class="flex justify-between bg-[#1C1C1C] text-white p-5 items-center fixed top-0 w-full z-10">
    ...
    <ul id="navMenu" class="hidden md:flex md:gap-1 md:items-center md:flex-row absolute md:static bg-[#1C1C1C] w-full left-0 top-[60px] md:top-auto md:w-auto md:bg-transparent" style="font-family: 'Instrument Sans'; font-weight: 400;">
        <li class="nav-item p-3 md:p-0 mx-auto text-center md:mr-5"><a href="#home">Home</a></li>
        <li class="nav-item p-3 md:p-0 mx-auto text-center md:mr-5"><a href="#service">Service</a></li>
